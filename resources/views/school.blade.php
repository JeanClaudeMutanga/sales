            ...
            <div class="">
                 ...
                 <div class="card shadow mb-4">
                      <div class="card-header py-3">
                          <h6 class="m-0 font-weight-bold text-primary">{{$school->name}}: Profile</h6>
                      </div>
                        <div class="card-body">
                              <!------Card---->
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content card w-100">
                        <div class="modal-body">
                            <form id="CustomerForm" name="CustomerForm" class="form-horizontal" action ="/attachments/redheart/{{$school->id}}" method="POST" enctype="multipart/form-data">
                                @csrf
