        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
              ...
              <div class="card-header py-3">
                <h6 class="font-weight-bold text-primary">Edit Appointment</h6>
              </div>

              <div class="mt-2">
                  <form class="user" method="POST" action="/agent/event/update/{{$event->id}}">
                        @csrf
                        <div class="form-group">
                            <input id="title" type="text" class="form-control @error('title') is-invalid @enderror form-control-user" name="title" value="{{$event->title}}" required autofocus>
                            @error('title')
                        ...
                        <div class="form-group">
                            <input id="start" type="text" class="form-control @error('start') is-invalid @enderror form-control-user" name="start" value="{{$event->start}}" required>
                            @error('start')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group">
                            <input id="end" type="text" class="form-control @error('end') is-invalid @enderror form-control-user" name="end" value="{{$event->end}}" required>
                            @error('end')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
              ...
              <div class="card-header py-3 mt-2">
                <h6 class="font-weight-bold text-primary">Other Recent Appointments</h6>
              </div>
              <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td>{{$total->end}}</td>
                        <td>
                            <a href="/event/edit/{{$total->id}}" class="btn btn-success btn-md">Edit</a>
                        </td>
                    </tr>
